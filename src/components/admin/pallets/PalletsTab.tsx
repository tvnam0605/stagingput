...
const selectedDeletable = [...selected].filter(id =>
    ...
    <div style={{
      ...
      <div style={{
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: 10 }}>
          ...
          <span style={{ fontSize: 12, color: C.textMuted }}>({filtered.length}/{pallets.length})</span>
        </div>
        ...
        <div style={{ display: 'flex', gap: 8, alignItems: 'center' }}>
          ...
          <select
            ...
            style={{
              background: '#f0efe9', border: '1px solid rgba(0,0,0,0.1)',
              borderRadius: 8, color: '#1a1916', fontSize: 12,
        ...
        <table style={{ width: '100%', borderCollapse: 'collapse' }}>
          <thead style={{ position: 'sticky', top: 0, zIndex: 1 }}>
            <tr style={{ background: '#f5f4f0' }}>
              ...
              {['Mã', 'Status', 'Box', 'Ghi chú', 'Tạo lúc', ''].map(h => (
                <th key={h} style={{
          ...
          <tbody>
            {loading ? (
              <tr>
                <td colSpan={7} style={{ padding: '32px 16px', textAlign: 'center', fontSize: 13, color: '#a09e96' }}>
                  Đang tải...
                </td>
              </tr>
            ) : filtered.length === 0 ? (
  ...
  <span style={{
    ...
    background: p.boxes.length > 0 ? '#e8f0fb' : '#f0efe9',
    color: p.boxes.length > 0 ? '#0d4a8f' : '#a09e96',
